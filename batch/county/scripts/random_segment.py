...
def random_segment_cluster(sample):
    ...
    cluster_info = wc.auxiliary_info(cliquer, rand_wpool, [D_rand_miles], health_index = None, infection_data = data, extra_info = [sample])
...
rand_segment_data.to_csv('batch/county/data/northeast_random_segment_' + str(job_id) + '.csv')