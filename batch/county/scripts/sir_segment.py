...
if total_jobs > 1:
    est_waves.to_csv("batch/county/data/sir_waves" + str(job_id) + ".csv")
    est_cuts.to_csv("batch/county/data/sir_cuts" + str(job_id) + ".csv")
else:
    est_waves.to_csv("batch/county/data/sir_waves.csv")
    est_cuts.to_csv("batch/county/data/sir_cuts.csv")
