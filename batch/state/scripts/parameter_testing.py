...
def param_info(param_pair):
    ...
    #uni_data = wc.auxiliary_info(uni_cliquer, wpool_uni, [G_miles, G_density], containment_health, data, extra_info = ['uni',None, p, t])
    ...
    #sir_data = wc.auxiliary_info(sir_cliquer, wpool_sir, [G_miles, G_density], containment_health, data, extra_info = ['sir',None, p, t])
    ...
    #wav_data = wc.auxiliary_info(wav_cliquer, wpool_wav, [G_miles, G_density], containment_health, data, extra_info = ['wav',None, p, t])
    ...
    for s in range(samples_per):
        ...
        #r_uni_data = wc.auxiliary_info(r_uni_cliquer, wpool_uni, [G_miles, G_density], containment_health, data, extra_info = ['random_uni',s, p, t])
        ...
        #r_sir_data = wc.auxiliary_info(r_sir_cliquer, wpool_sir, [G_miles, G_density], containment_health, data, extra_info = ['random_sir',s, p, t])
        ...
        #r_wav_data = wc.auxiliary_info(r_wav_cliquer, wpool_wav, [G_miles, G_density], containment_health, data, extra_info = ['random_wav',s, p, t])
        ...
        r_cliquer.D = empty_D
        #r_data = wc.auxiliary_info(r_cliquer, rand_wpool, [G_miles, G_density], containment_health, data, extra_info = ['random',s, p, t])
...
overlap_try = np.linspace(0.1,1,37)
threshold_try = np.linspace(0,0.5,101)
...
parameter_info.to_csv('batch/state/data/parameter_info.csv')